...
| 20260721 | /builder(Alembic 베이스라인) | content 베이스라인 `aa3ccec70626`(generation_jobs·scripts·contents) 신설(직전 create_all 부채 해소). publishing도 alembic 신설 + `ba3a7f7a1796`(publish_records). 빈 temp DB `upgrade head` 검증. → `doc/summary/20260721-summary-alembic-baseline.md` |
