...
from app.consumer import run_consumer, run_macro_consumer, run_tick_consumer
...
async def lifespan(app: FastAPI) -> AsyncIterator[None]:
    ...
    macro_task = asyncio.create_task(run_macro_consumer())  # research.macro → MacroIndicator 소비
    try:
        yield
    finally:
